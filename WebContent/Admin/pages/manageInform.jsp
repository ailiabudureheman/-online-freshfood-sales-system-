    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 576px) {
            ...
            .content-preview { max-height: 100px; }
        }
    </style>
</head>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions">
                <button type="button" class="btn btn-danger" onclick="removeInform(${informPager.pageOffset}, ${informPager.pageSize})">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <c:forEach var="inform" items="${informList}">
                            <tr align="center" class="hover-bg">
                                ...
                                <td>
                                    <div class="content-preview">${inform.informContent}</div>
                                </td>
                                <td><input type="checkbox" name="delete" value="${inform.informId}"></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
...
<script>
    ...
    function removeInform(pageOffset, pageSize) {
        ...
        if (!confirm("确定要删除选中的" + count + "条公告吗？此操作不可恢复")) {
            return false;
        }
