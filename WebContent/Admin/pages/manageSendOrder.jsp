	...
	<div class="card">
		<div class="card-header">
			...
			<div class="card-actions">
				<button type="button" class="btn btn-warning" onclick="freezeOrder(${orderPager.pageOffset}, ${orderPager.pageSize})">
					<i class="fas fa-lock"></i> 冻结选中
				</button>
					...
					<table class="table table-striped table-hover">
						...
						<c:forEach var="order" items="${orderList}">
							<tr align="center" class="hover-bg">
								...
								<td>
                        <span class="status-pill ${order.flag == 0 ? 'status-pending' : order.flag == 1 ? 'status-processing' : 'status-frozen'}">
								${order.flag}
						</span>
								</td>
...
<script>
	...
	function freezeOrder(pageOffset, pageSize) {
		...
		if (!confirm("确定要冻结选中的" + count + "个订单吗？")) {
			return false;
		}
