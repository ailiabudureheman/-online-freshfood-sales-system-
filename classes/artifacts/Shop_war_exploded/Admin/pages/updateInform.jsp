    ...
    <main class="main-content">
        ...
        <div class="content-container">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="updateInformForm" action="updateInformServlet" method="post">
                        <input type="hidden" id="informId" name="informId" value="${inform.informId}" readonly>

                        <div class="form-group">
                            <label for="informTitle">
                                <i class="fas fa-heading"></i> 公告标题
                                <span class="required">*</span>
                            </label>
                            <input type="text" id="informTitle" name="informTitle"
                                   class="form-control" value="${inform.informTitle}"
                                   placeholder="请输入公告标题（不超过100字）">
                            <div class="form-error" id="titleError"></div>
                        </div>

                        <div class="form-group">
                            <label for="informContent">
                                <i class="fas fa-paragraph"></i> 公告内容
                                <span class="required">*</span>
                            </label>
                            <textarea id="informContent" name="informContent"
                                      class="form-control" rows="10">${inform.informContent}</textarea>
                            <div class="form-error" id="contentError"></div>
                        </div>

                        <div class="form-actions">
                            <button type="button" class="btn btn-primary" onclick="updateInform()">
                                <i class="fas fa-save"></i> 保存修改
                            </button>
                            <button type="reset" class="btn btn-secondary">
                                <i class="fas fa-undo"></i> 重置
                            </button>
                            <a href="getInformPagerServlet" target="contentIframe" class="btn btn-secondary">
