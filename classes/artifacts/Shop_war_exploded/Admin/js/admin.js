...
function manageInventory(self) {
	var manageInventory = document.getElementById("manageInventory");
	manageInventory.style.display = manageInventory.style.display == "none" ? "block" : "none";
	if (manageInventory.style.display == "none") {
		self.src = "Admin/images/manageInventoryDown.jpg";
	} else {
		self.src = "Admin/images/manageInventoryUp.jpg";
	}
}